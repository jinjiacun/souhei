...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >添加企业</th>
  </tr>
  <tr>
    <td class="CPanel">
			...
			<TD width="100%">
				...
				<legend>添加企业</legend>
					  ...
					  <tr>
					    ...
					    <td width="35%">
                                            <select id="trade" name="trade" onchange="trade_change();">
                                            <?php if(is_array($trade_list)): $i = 0; $__LIST__ = $trade_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$trade): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($trade); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
				            <span class="red">*</span></td>
					   </tr>
					    ...
					    <td width="35%"><input id="company_name" name='company_name' type="text" class="text" style="width:154px" value="" onblur="check_company_name()"/>
				            <span class="red">*</span></td>
					   </tr>
					    ...
					    <td width="35%">
                                            <textarea id="company_alias" name='company_alias' cols="30" rows="3"></textarea>注:之间用逗号隔开
				            </td>
					   </tr>
					    ...
					    <td width="35%">
                                            ...
                                            <option value="006002">未验证</opttion>
                                            <option value="006001">黑平台</opttion>
                                            <option value="006003">合规</opttion>
                                            </select>
				            </td>
					   </tr>
					    ...
					    <td width="35%"><input name='reg_address' type="text" class="text" style="width:154px" />
				            </td>
					   </tr>
					    ...
					    <td width="35%">
                                            <input id="control_busin_license" type="checkbox" onclick="is_file_upload();"/>
                                            <input name='busin_license' id="busin_license" type="file" style="width:154px;display:none;" />
				            </td>
					   </tr>
					    ...
					    <td width="35%">
                                            <input id="control_code_certificate" type="checkbox" onclick="is_file_upload();"/>
                                            <input name='code_certificate' id="code_certificate" type="file" style="width:154px;display:none;"/>
				            </td>
					   </tr>
                                           
                                           <tr>
					    <td nowrap align="right" width="30%">联系电话:</td>
					    <td width="35%"><input name='telephone' type="text" class="text" style="width:154px" value="" />
				            </td>
					   </tr>
                                           
                                           <tr>
					    <td nowrap align="right" width="30%">官方网址:</td>
					    <td width="35%"><input id="website" name='website' type="text" class="text" style="width:154px" value="" />
				            </td>
					   </tr>
                                           
                                           <tr>
					    <td nowrap align="right" width="30%">官网备案:</td>
					    <td width="35%"><input name='record' type="text" class="text" style="width:154px" value="" />
				            </td>
					   </tr>
                                           
                                           <tr id="id_regulators_id" style="display:none;">
					    <td nowrap align="right" width="30%">监管机构:</td>
					    <td width="35%">
                                             <select name='regulators_id' id="regulators_id">
                                             <option value=0>---请选择监管机构---</option>
                                             <?php if(is_array($regulators_list)): $i = 0; $__LIST__ = $regulators_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$regulators): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($regulators); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                             </select>
				            </td>
					   </tr>
					    ...
					    <td width="35%"><input id="find_website" name='find_website' type="text" class="text" style="width:154px" value="" />
				            </td>
					   </tr>
					    ...
					    <td width="35%">
                                            ...
                                            <!--
                                            <option value=0>暂无代理平台</option>
                                            <?php if(is_array($agent_flatform_list)): $i = 0; $__LIST__ = $agent_flatform_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$agent_flatform): $mod = ($i % 2 );++$i;?><option value=<?php echo ($key); ?>><?php echo ($agent_flatform); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            -->
                                            </select>
				            </td>
					   </tr>
					    ...
					    <td width="35%"><input id="mem_sn" name='mem_sn' type="text" class="text" style="width:154px" value="" />
				            </td>
					   </tr>
					    ...
					    <td width="35%">
                                            <input id="control_certificate" type="checkbox" onclick="is_file_upload();"/>
                                            <input id="certificate" name='certificate' type="file" style="width:154px;display:none;"/>
				            </td>
					   </tr>
