              ...
              <tr>
                <td height="40" class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
                  ...
                  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr align="center">
                    ...
                    <td height="20" bgcolor="#FFFFFF"><?php echo ($exposal_list[$item['exposal_id']]); ?></td>
                    ...
                    <td bgcolor="#FFFFFF">
                        <?php if(0 == $item['is_validate']): ?><a href="javascript:request_get('/yms/index.php/Soadmin/Comment/validate_exposal/id/<?php echo ($item["id"]); ?>');">审核</a<?php endif; ?>
                     </td>
