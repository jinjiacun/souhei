...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >关联企业</th>
  </tr>
  <tr>
    <td class="CPanel">
				...
				<legend>关联企业</legend>
					  <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
					    ...
					    <td width="35%">
                                            ...
                                            <?php if(is_array($company_list)): $i = 0; $__LIST__ = $company_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$company): $mod = ($i % 2 );++$i;?><option value='<?php echo ($key); ?>' <?php if($key == $company_id): ?>selected="selected"<?php endif; ?>><?php echo ($company); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
