    ...
    <td><table id="subtree1" style="DISPLAY: " width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
		    ...
		    <td bgcolor="#FFFFFF" align="left"><input type="checkbox" name="delid" <?php if(0 != $status): ?>style="display:none"<?php endif; ?>/><?php echo ($item["id"]); ?></td>
                    ...
                    <td bgcolor="#FFFFFF">
                       <?php if(0 == $item['company_id'] and 0 == $item['is_delete']): ?><a href="/yms/index.php/Soadmin/Inexposal/edit/id/<?php echo ($item["id"]); ?>/company_id/<?php echo ($item["company_id"]); ?>">关联企业</a>
                       |&nbsp;<?php endif; ?>
                       <a href='/yms/index.php/Soadmin/Inexposal/view/id/<?php echo ($item["id"]); ?>'>查看</a>
                       <?php if(0 == $item['is_delete']): ?><a href='javascript:request_get("/yms/index.php/Soadmin/Inexposal/delete/id/<?php echo ($item["id"]); ?>/company_id/<?php echo ($item["company_id"]); ?>")' onclick="return confirmdel('确定要删除吗')">删除</a><?php endif; ?>
                     </td>
