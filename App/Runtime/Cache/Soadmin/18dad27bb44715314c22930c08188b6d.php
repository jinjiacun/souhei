    ...
    <td><table id="subtree1" style="DISPLAY: " width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
	       ...
	       <a href="/yms/index.php/Soadmin/Admin/add">添加管理员</a>
               </td>
          	 </tr>
              <tr>
		    ...
		    <td width="5%" align="center" bgcolor="#EEEEEE">选择</td>
                    <td width="10%" height="20" align="center" bgcolor="#EEEEEE">管理员名称</td>
                    <td width="10%" height="20" align="center" bgcolor="#EEEEEE">添加日期</td>
                  ...
                  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr align="center">
                    ...
                    <td height="20" bgcolor="#FFFFFF"><?php echo ($item["admin_name"]); ?></td>
                    <td height="20" bgcolor="#FFFFFF"><?php echo (date('Y-m-d H:i:s',$item["add_time"])); ?></td>
                    <td height="20" bgcolor="#FFFFFF">
                    <a href="/yms/index.php/Soadmin/Admin/edit/id/<?php echo ($item["id"]); ?>/admin_name/<?php echo ($item["admin_name"]); ?>">编辑</a>
                    <a href="/yms/index.php/Soadmin/Admin/delete/id/<?php echo ($item["id"]); ?>" onclick="return confirmdel('确定要删除吗')">删除</a>
                    </td>
