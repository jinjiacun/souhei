          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
	       ...
	       <!--
		    ...
		    <td width="5%" align="center" bgcolor="#EEEEEE">选择</td>
                  ...
                  <?php if(is_array($news_list)): $i = 0; $__LIST__ = $news_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?><tr align="center">
                    <td bgcolor="#FFFFFF"><input type="checkbox" name="id[]" value="<?php echo ($news["id"]); ?>"/><?php echo ($news["id"]); ?></td>
                    <td height="20" bgcolor="#FFFFFF"><?php echo ($company_list[$news['company_id']]); ?></td>                        
                    <td height="20" bgcolor="#FFFFFF"><?php echo ($news["title"]); ?></td>
                    <td height="20" bgcolor="#FFFFFF"><?php echo ($news["author"]); ?></td>
                    <td height="20" bgcolor="#FFFFFF"><?php echo ($news["source"]); ?></td>
                    <td bgcolor="#FFFFFF">
                        <a href="/yms/index.php/Soadmin/News/edit/id/<?php echo ($news["id"]); ?>">编辑</a>|
                        <a href="javascript:request_get('/yms/index.php/Soadmin/News/delete/id/<?php echo ($news["id"]); ?>');" onclick="return confirmdel('确定要删除吗')">删除</a>
                     </td>
