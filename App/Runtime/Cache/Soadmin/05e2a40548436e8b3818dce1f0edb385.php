			...
			<TD width="100%">
				...
				<legend>添加监管机构</legend>
					  ...
					  <tr>
					    ...
					    <td width="35%">
                                            <select name="type">
                                            <option value="002001" <?php if('002001' == $obj['type']): ?>selected="selected"<?php endif; ?>>贵金属监管机构</option>
                                            <option value="002002" <?php if('002002' == $obj['type']): ?>selected="selected"<?php endif; ?>>外汇监管机构</option>
                                            </select>
					    ...
					    <td width="35%"><input type="text" name="title" value="<?php echo ($obj["title"]); ?>"/><span class="red">*</span></td>
					   </tr>
                                           
                                           <tr>
					    <td nowrap align="right" width="30%">官网:</td>
					    <td width="35%"><input type="text" name="website" value="<?php echo ($obj["website"]); ?>"/><span class="red">*</span></td>
					   </tr>
					 
                                           <tr>
					    <td nowrap align="right" width="30%">图片:</td>
					    <td width="35%"><input type="file" name="pic" />
                                            <img src="<?php echo ($obj["pic_url"]); ?>" width="25px" height="25px"/>
                                            <span class="red">*</span></td>
					   </tr>
                                           
                                           <tr>
					    <td nowrap align="right" width="30%">内容:</td>
					    <td width="35%"><textarea name="content"><?php echo ($obj["content"]); ?></textarea><span class="red">*</span></td>
					   </tr>
