...
<!--内容--Begin-->     
   <div id="content">
     <div class="weislbox">
        <div class="dibubj">
            <h2><span><?php echo (subtext($wsl,10)); ?></span>的查询结果：</h2>
            <p class="wsr1">暂未收录该平台</p>
            <p class="wsr2">您可以去曝光或认证该平台</p>
            <p class="wsr3">
              <a href="/yms/index.php/Home/Inexposure/exposure">我要曝光</a>
              <a href="/yms/index.php/Home/Inexposure/authentication">我要认证</a>
            </p>
        </div>
     </div>
  </div>
