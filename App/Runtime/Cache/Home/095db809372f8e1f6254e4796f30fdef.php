...
<!--内容--Begin-->     
   <div id="content">
     <div class="cxjg_tit">
     <h3>查询结果：暂未通过合规认证</h3>
          <div class="cxjg_tit_rt">
            <ul>
              <li class="frists"><span>加黑</span><em><?php echo ($wrz_list["add_blk_amount"]); ?></em></li>
                <li><span>点赞</span><em><?php echo ($wrz_list["assist_amount"]); ?></em></li>
                <li><span>评论</span><em><?php echo ($wrz_list["com_amount"]); ?></em></li>
                <li><span>曝光</span><em><?php echo ($wrz_list["exp_amount"]); ?></em></li>
            </ul>
          </div>
     </div>
     <div class="hptbox2 wrzbox2">
        <dl>
        	<dt>
            <?php if($wrz_list["logo_url"] != '' ): ?><img src="<?php echo ($wrz_list["logo_url"]); ?>" /><?php endif; ?>
          </dt>
          <dd class="mizx">
          	<h3><a><?php echo ($wrz_list["company_name"]); ?></a></h3>
              <p><span>其他名称</span>
          ...
          <dd class="dzjh_btn">
                <a id="<?php echo ($wrz_list["id"]); ?>" href="javascript:void(0)" class="dianzjh1">点赞</a>
                <a id="<?php echo ($wrz_list["id"]); ?>" href="javascript:void(0)" class="dianzjh2">加黑</a>
                <b id="bb">+1</b>
          </dd>
        </dl>
        <div class="gongsijs">
           <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="320">
                <?php if($wrz_list["agent_platform_n"] != '' ): ?><a style="color: #183e60;" href="/yms/index.php/Home/<?php echo ($rzjb_url); ?>" target="_blank"><em><?php echo ($wrz_list["agent_platform_n"]); ?></em></a>
                <?php else: ?>
                数据正在整理...<?php endif; ?>
                </td>
                <td width="76"><span>会员编号</span></td>
                <td width="230">
                <?php if($wrz_list["mem_sn"] != '' ): ?><em><?php echo ($wrz_list["mem_sn"]); ?></em>
                <?php else: ?>
                数据正在整理...<?php endif; ?>
                </td>
                <td width="76"><span>监管机构</span></td>
                <td>
                <?php if($wrz_list["regulators_id_n"] != '' ): echo ($wrz_list["regulators_id_n"]); ?>
                <?php else: ?>
                数据正在整理...<?php endif; ?>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <?php if($wrz_list["busin_license"] > 0 ): ?><img src="/yms/Public/Home/images/pic20b.jpg" width="44" height="42"/>
                  <?php else: ?>
                    <img src="/yms/Public/Home/images/pic20a.jpg" width="44" height="42"/><?php endif; ?>
                </td>
                <td><span>机构代码证</span></td>
                <td>
                   <?php if($wrz_list["code_certificate"] > 0 ): ?><img src="/yms/Public/Home/images/pic20b.jpg" width="44" height="42"/>
                   <?php else: ?>
                    <img src="/yms/Public/Home/images/pic20a.jpg" width="44" height="42"/><?php endif; ?>
                </td>
                <td><span>资质证明</span></td>
                <td>
                    <?php if($wrz_list["certificate"] > 0 ): ?><img src="/yms/Public/Home/images/pic20b.jpg" width="44" height="42"/>
                    <?php else: ?>
                      <img src="/yms/Public/Home/images/pic20a.jpg" width="44" height="42"/><?php endif; ?>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                <?php if($wrz_list["telephone"] != '' ): echo ($wrz_list["telephone"]); ?>
                <?php else: ?>
                数据正在整理...<?php endif; ?>
                </td>
                <td><span>官方网站</span></td>
                <td>
                <?php if($wrz_list["website"] != '' ): ?><a href="<?php echo ($wrz_list["website"]); ?>" target="_blank"><?php echo ($wrz_list["website"]); ?></a>
                <?php else: ?>
                数据正在整理...<?php endif; ?>                
                </td>
                <td><span>官网备案</span></td>
                <td>
                <?php if($wrz_list["record"] != '' ): echo ($wrz_list["record"]); ?>
                <?php else: ?>
                数据正在整理...<?php endif; ?>
                </td>
              </tr>
              <tr>
                ...
                <td colspan="5">
                <?php if($wrz_list["reg_address"] != '' ): echo ($wrz_list["reg_address"]); ?>
                <?php else: ?>
                数据正在整理...<?php endif; ?>
                </td>
              </tr>
       ...
       <div class="mtbaod">
          ...
          <?php if(is_array($new_list)): $i = 0; $__LIST__ = $new_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new_list): $mod = ($i % 2 );++$i;?><dl>
                ...
                <dd>
                  <h4><a href="/yms/index.php/Home/Article/article/id/<?php echo ($new_list["id"]); ?>/company_id/<?php echo ($new_list["company_id"]); ?>/p/1/"><?php echo ($new_list["title"]); ?></a></h4>
                    <div><?php echo (subtext($new_list["content"],110)); ?></div>
                    <span><?php echo (date('Y-m-d H:i',$new_list["add_time"])); ?></span>
                </dd>
        ...
        <div class="baoguan_pl">
            <div class="baoguan_pl1 bgbox_tit">
               ...
               <?php else: ?>(999+)<?php endif; ?></span></a><em>|</em>
               <a href="javascript:;" onclick="show_panel(this)" id="link_basic_setting">网友曝光<span>
                     ...
                     <dd class="pinglubox_rt">
                        ...
                        <?php else: ?>
                          <em class="tiwen"></em><?php endif; ?>
                           <span><?php echo ($con_p["content"]); ?></span>
                        </p>
                        <div class="tubox">
                        ...
                        <div class="hfpl_chd">
                          <div class="timens">
                            ...
                            <a class="ding" id="<?php echo ($con_p["id"]); ?>" rel="<?php echo ($con_p["id"]); ?>" href="javascript:void(0)">顶 <em>(<?php echo ($con_p["top_num"]); ?>)</em></a>|
                     ...
                     <dd class="pinglubox_rt">
                          ...
                          <div class="bggs">
                              <div class="bggs_lt"><span>被曝光公司：</span><a title="<?php echo ($con_b["company_name"]); ?>"><?php echo (subtext($con_b["company_name"],11)); ?></a></div>
                                <div class="bggs_rt"><span>官方网址：</span><a href="<?php echo ($con_b["website"]); ?>" target="_blank" title="<?php echo ($con_b["website"]); ?>"><?php echo (subtext($con_b["website"],24)); ?></a></div>
                          </div>
                          <p class="pinglubox_xs"><?php echo ($con_b["content"]); ?></p>
                          <div class="tubox">
                            <?php if($con_b["pic_1_url"] != ''): ?><a href="<?php echo ($con_b["pic_1_url"]); ?>" rel="lightbox[plants]"><img src="<?php echo ($con_b["pic_1_url"]); ?>"/></a><?php endif; ?>
      ...
      <div  id="fixeds">
       ...
       <form id="theForm" name="theForm" method="post" enctype="multipart/form-data" onsubmit="return ValidateFile()">
         ...
         <p class="wypl_wypl4">
            ...
            <input type="hidden" id="hidden_id" name="company_id" value="<?php echo ($wrz_list["id"]); ?>">
         </p>
         </form>
       </div>
  ...
  $(function(){
      ...
      $('.dianzjh1').click(function(){
              ...
              $.ajax({  
                  ...
                  timeout: 5000,  
                  dataType:"json",  
                  data:{"method":"Companyassist.add","type":"text",
                  "content":{"company_id":id,"user_id":userid}},
                  success: function aa(data) {  
                       if (200 == data.status_code) {
                          if (0 == data.content.is_success) {
                            if(!$('#bb').is(':visible')){ 
...
$(function(){
      ...
      var companyid = '<?php echo ($wrz_list["id"]); ?>';
      var flag=false;
      $(".hyh").click(function(){
