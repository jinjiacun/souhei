...
<title>交易市场</title>
<meta name="keywords" content="交易市场"/>
<meta name="description" content="搜黑，黄金、外汇、贵金属交易黑幕曝光平台，联合国内外多家权威机构甄选安全可靠的交易平台，为投资者创造良好的交易投资环境。"/>
   ...
   <div id="content_ny">
     <div class="cont_lt">
              <div class="cont_lta">
                ...
                <ul>
                   <li><a href="/yms/index.php/home/Index/index">平台查询</a></li>
                   <li><a target="_blank" class="wybg_a" href="/yms/index.php/home/Inexposure/exposure">我要曝光</a></li>
                   <li><a target="_blank" class="wybg_a" href="/yms/index.php/home/Inexposure/authentication">合规认证</a></li>
                   <li><a target="_blank" href="/yms/index.php/home/Ranking/machine">曝光台</a></li>
                   <li><a href="/yms/index.php/home/Regulators/regulators">监管机构</a></li>
                 </ul>
                 <div class="ewm"><img src="/yms/Public/Home/images/pic01.jpg" width="104" height="140" /></div>
                <div class="wybg wybg_a"><a href="/yms/index.php/home/Inexposure/exposure">我要曝光</a></div>
          </div>
     ...
     <div class="content_ny_lt">
       <div class="jigou">
         <ul class="tit">
              <li class="activ">贵金属监管机构</li>
              <li>外汇监管机构</li>
         </ul>
         <div class="jg_nr yis1 show">
           <ul>
            <?php if(is_array($g_list)): $i = 0; $__LIST__ = $g_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g_list): $mod = ($i % 2 );++$i;?><li>
               <div class="jq_nr_lt">
                  <h4><?php echo ($g_list["title"]); ?></h4>
                  <p>官网：<a href="<?php echo ($g_list["website"]); ?>" target='_blank' title='<?php echo ($g_list["website"]); ?>'><?php echo (subtext($g_list["website"],20)); ?></a></p>
                  <p class="img_jq"><a href="#"><img src="<?php echo ($g_list["pic_url"]); ?>" width="232" height="60" /></a></p>
               </div>
               <div class="jq_nr_rt">
               <p><?php echo ($g_list["content"]); ?></p></div>
             </li><?php endforeach; endif; else: echo "" ;endif; ?>
           </ul>
         </div>
         <div class="jg_nr yis2 hide">
           <ul>
            <?php if(is_array($w_list)): $i = 0; $__LIST__ = $w_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$w_list): $mod = ($i % 2 );++$i;?><li>
               <div class="jq_nr_lt">
                  <h4><?php echo ($w_list["title"]); ?></h4>
                  <p>官网：<a href="<?php echo ($w_list["website"]); ?>" target='_blank'><?php echo (subtext($w_list["website"],20)); ?></a></p>
                  <p class="img_jq"><a href="#"><img src="<?php echo ($w_list["pic_url"]); ?>" width="232" height="60" /></a></p>
               </div>
               <div class="jq_nr_rt">
               <p><?php echo ($w_list["content"]); ?></p></div>
             </li><?php endforeach; endif; else: echo "" ;endif; ?>
           </ul>
         </div>
       </div>
